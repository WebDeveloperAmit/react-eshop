                    ...
                    <nav className="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                        ...
                        <div className="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div className="navbar-nav mr-auto py-0">
                                <Link 
                                to="" 
                                className={`nav-item nav-link ${location.pathname === '/' ? 'active' : ''}`}>Home</Link>
                                <Link 
                                to="/shop" 
                                className={`nav-item nav-link ${location.pathname === '/shop' ? 'active' : ''}`}>Shop</Link>
                                <Link 
                                to="/cart" 
                                className={`nav-item nav-link ${location.pathname === '/cart' ? 'active' : ''}`}>Shopping Cart</Link>
                                <Link 
                                to="/checkout" 
                                className={`nav-item nav-link ${location.pathname === '/checkout' ? 'active' : ''}`}>Checkout</Link>
                                {/* <div className="nav-item dropdown">
